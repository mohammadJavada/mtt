...
const CustomerInfo = ({ formik, imgsSrc, setImgsSrc, inUpdate = false }) => {
  useEffect(() => {
  ...
  return (
    <>
      ...
      {!inUpdate && (
        <FormInput formik={formik} label="شماره موبایل" name="mobile_number" />
      )}
      {!inUpdate && (
        <FormInput
          formik={formik}
      ...
      <div className="grid lg:col-span-4 lg:grid-cols-4 md:col-span-2 md:grid-cols-2 col-span-1 grid-cols-1 gap-6 mt-6">
        <div className="lg:col-span-2 md:col-span-2 col-span-1">
          <ImageUploader
            ...
            formik={formik}
            name="national_file"
            title="تصویر کارت ملی خود را بارگذاری کنید."
            imageCount={1}
          />
        </div>
      </div>
