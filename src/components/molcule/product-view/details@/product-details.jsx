...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block", background: "#2255fc", borderRadius: "50%", marginRight: "30px"}}
      onClick={onClick}
    />
  );
}
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block", background: "#2255fc", borderRadius: "50%", marginLeft: "30px", zIndex: 1 }}
      onClick={onClick}
    />
  );
}
            ...
            {base64Images?.length == 0 ? (
              ...
              <>
                ...
                <Slider {...settings}>
                  {base64Images?.map((sliderItem, index) => (
                    <div key={index}>
                      <img src={`data:image/png;base64,${sliderItem}`} style={{width: "100%", objectFit: "scale-down"}}/>
                    </div>
                  ))}
                </Slider>
