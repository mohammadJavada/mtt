...
const MainPageFilter = ({
  ...
  const handleFilterClick = async () => {
    ...
    const data = {
      ...
      colors: dataFilter?.colors?.join(",")
        ...
        : "",
      with_imagends: dataFilter.with_image,
  ...
  return (
    <div
      className={`filter-sidebar overflow-auto custom-scrollbar lg:flex lg:sticky lg:top-40 fixed bg-white lg:right-auto py-5 px-6 lg:w-full md:w-1/2 tablet:w-1/2 sx:w-full w-screen lg:max-h-[80vh] h-screen transition-all ${classes} flex-col overflow-y-scroll justify-between bg-white p-4 rounded-lg custom-shadow`}
    >
